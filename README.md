...
- **[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/DuminduE/turbine-power-estimation/main?filepath=WT_power_est_demo.ipynb)** Click the badge above to open `demo.ipynb` with interactive sliders and plots.  
